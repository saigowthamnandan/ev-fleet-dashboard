      ...
      <div className="space-y-3 max-h-58 overflow-y-auto h-full">
        {alerts.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 dark:text-gray-400">{t('noActiveAlerts')}</p>
          </div>
        ) : (
          alerts.map((alert) => (
            <div
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{alert.timestamp.toLocaleTimeString()}</p>
                  </div>
                </div>
                <button onClick={() => onDismissAlert(alert.id)} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
