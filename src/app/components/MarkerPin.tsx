  ...
  return (
    <div className="flex flex-col items-center gap-0 relative">
      <div
        ...
        <SvgIcon name={imageName} width={width || 24} height={height || 24} alt="Marker" />
      </div>
      <div
        className={`absolute -bottom-2.5 border-x-8 border-x-transparent border-b-transparent border-t-12 border-${borderColor}-600`}></div>
    </div>
  );
}
